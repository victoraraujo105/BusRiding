# Código fonte de módulo na sua última versão.
# Dele, usamos widgets para a interface gráfica.
# Faz parte da coleção nativa de módulos do Python.
# O copiamos manualmente para o projeto de modo a evitar
# incompatibilidade com versões do Python inferiores à 3.7.
# Entretanto, poderia ser importado usando from tkinter import ttk.
"""Ttk wrapper.
