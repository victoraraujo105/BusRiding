...
COLUNAS_LINHAS = ('campus', 'partida', 'assentos livres',
                  'inteira')  # nomes das colunas da planilha
COLUNAS_RESERVAS = ('campus', 'partida', 'assento', 'passagem')
DESTINOS_INICIAIS = ['Benfica', 'Pici',
                     'Porangabuçu', 'Quixadá', 'Russas', 'Sobral']
...
ACOES_COMPLEMENTARES = {'add': 'Descadastro', 'rmv': 'Restauração', 'book': 'Devolução',
                        'show': 'Desabilitar', 'refund': 'Reservar', 'import_reservas': 'Devolução'}
...
ESTRUTURA_LINHA = namedtuple(
    'ESTRUTURA_LINHA', ['destino', 'horario', 'fileiras', 'inteira', 'onibus'])
